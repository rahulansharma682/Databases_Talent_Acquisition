...
if menu == "Add Recruiter":
    ...
    query_option = st.selectbox(
        ...
        [
            ...
            "Top Recruiters by Candidate Success",
    ...
    if connection:
        ...
        elif query_option == "Top Recruiters by Candidate Success":
            st.subheader("Top Recruiters by Candidate Success")
            try:
                ...
                if connection:
                    ...
                    query = """ SELECT r.ContactPerson, COUNT(c.CandidateID) AS CandidatesHired
                    FROM Recruiter r
                    JOIN Job j ON r.ContactPerson = j.ContactPerson
                    ...
                    if results and len(results) > 0:
                        import pandas as pd
                        df = pd.DataFrame(results, columns=["Recruiter", "Candidates Hired"])
                        st.table(df)
                    else:
